...
export default function HomePage() {
  return (
    <main>
      <section className="relative isolate h-[360px] overflow-hidden sm:h-[440px]">
        <HeroVideo />
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 text-center">
        <p className="text-xs font-semibold uppercase tracking-widest text-brand-navy/70">
          SturdiHome Network LLC
        </p>
        <h1 className="mx-auto mt-3 max-w-3xl font-display text-4xl font-semibold text-brand-navy sm:text-5xl">
